...
def inception_v3(width, height, lr, output=9, model_name='sentnet_color.model'):
	...
	conv1_7_7 = conv_2d(network, 64, 10, strides=2, activation='relu', name='conv1_7_7_s2')
	pool1_3_3 = avg_pool_2d(conv1_7_7, 3, strides=2)
	pool1_3_3 = local_response_normalization(pool1_3_3)
	conv2_3_3_reduce = conv_2d(pool1_3_3, 64, 1, activation='relu', name='conv2_3_3_reduce')
	conv2_3_3 = conv_2d(conv2_3_3_reduce, 192, 3, activation='relu', name='conv2_3_3')
	conv2_3_3 = local_response_normalization(conv2_3_3)
	pool2_3_3 = avg_pool_2d(conv2_3_3, kernel_size=3, strides=2, name='pool2_3_3_s2')
	inception_3a_1_1 = conv_2d(conv2_3_3, 64, 1, activation='relu', name='inception_3a_1_1')
	inception_3a_3_3_reduce = conv_2d(pool2_3_3, 96, 1, activation='relu', name='inception_3a_3_3_reduce')
	inception_3a_3_3 = conv_2d(inception_3a_3_3_reduce, 128, filter_size=3, activation='relu', name='inception_3a_3_3')
	inception_3a_5_5_reduce = conv_2d(pool2_3_3, 16, filter_size=1, activation='relu', name='inception_3a_5_5_reduce')
	inception_3a_5_5 = conv_2d(inception_3a_5_5_reduce, 32, filter_size=5, activation='relu', name='inception_3a_5_5')
	inception_3a_pool = avg_pool_2d(pool2_3_3, kernel_size=3, strides=1, )
	...
	inception_3b_pool = avg_pool_2d(inception_3a_output, kernel_size=3, strides=1, name='inception_3b_pool')
	...
	pool3_3_3 = avg_pool_2d(inception_3b_output, kernel_size=3, strides=2, name='pool3_3_3')
	inception_4a_1_1 = conv_2d(pool3_3_3, 192, filter_size=1, activation='relu', name='inception_4a_1_1')
	inception_4a_3_3_reduce = conv_2d(pool3_3_3, 96, filter_size=1, activation='relu', name='inception_4a_3_3_reduce')
	inception_4a_3_3 = conv_2d(inception_4a_3_3_reduce, 208, filter_size=3, activation='relu', name='inception_4a_3_3')
	inception_4a_5_5_reduce = conv_2d(pool3_3_3, 16, filter_size=1, activation='relu', name='inception_4a_5_5_reduce')
	inception_4a_5_5 = conv_2d(inception_4a_5_5_reduce, 48, filter_size=5, activation='relu', name='inception_4a_5_5')
	inception_4a_pool = avg_pool_2d(pool3_3_3, kernel_size=3, strides=1, name='inception_4a_pool')
	...
	inception_4b_pool = avg_pool_2d(inception_4a_output, kernel_size=3, strides=1, name='inception_4b_pool')
	...
	inception_4c_pool = avg_pool_2d(inception_4b_output, kernel_size=3, strides=1)
	...
	inception_4d_pool = avg_pool_2d(inception_4c_output, kernel_size=3, strides=1, name='inception_4d_pool')
	...
	inception_4e_pool = avg_pool_2d(inception_4d_output, kernel_size=3, strides=1, name='inception_4e_pool')
	...
	pool4_3_3 = avg_pool_2d(inception_4e_output, kernel_size=3, strides=2, name='pool_3_3')
	...
	inception_5a_pool = avg_pool_2d(pool4_3_3, kernel_size=3, strides=1, name='inception_5a_pool')
	...
	inception_5b_pool = avg_pool_2d(inception_5a_output, kernel_size=3, strides=1, name='inception_5b_pool')
	...
	loss = fully_connected(pool5_7_7, output, activation='softplus')
